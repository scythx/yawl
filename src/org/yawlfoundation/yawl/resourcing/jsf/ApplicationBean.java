...
public class ApplicationBean extends AbstractApplicationBean {
    ...
    public String updateExternalClient(String name, String pw, String email, String address, String doco) {
        try {
            return _rm.updateExternalClient(name, pw, email, address, doco);
        } catch (IOException ioe) {
    ...
    public String addExternalClient(String name, String pw, String email, String address, String doco) {
        String result;
        if (name.equals("admin")) {
            return "Cannot add client 'admin' because it is a reserved client name.";
        }
        try {
            YExternalClient client = new YExternalClient(name, pw, email, address, doco);
