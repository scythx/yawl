...
public interface EngineGateway extends Remote {
    ...
    String createAccount(String userName, String password, String email, String address, String doco, String sessionHandle) throws RemoteException;

    String updateAccount(String userName, String password, String email, String address, String doco, String sessionHandle) throws RemoteException;
