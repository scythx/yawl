...
public class InterfaceA_EnvironmentBasedClient extends Interface_Client {
     ...
     * @throws IOException if bad connection.
     */
    public String addClientAccount(String name, String password, String email, String address,
    ...
    public String addClientAccount(YExternalClient client, String sessionHandle)
            throws IOException {
        return addClientAccount(client.getUserName(), client.getPassword(), client.getEmail(),
                client.getAddress(), client.getDocumentation(), sessionHandle);
    }


    public String updateClientAccount(String name, String password, String email, String address,
                            String documentation, String sessionHandle) throws IOException {
